...
class Verifier:
    ...
    def compare_metrics(self, probe):
        ...
        #print('ORIGINAL SCORE WITH DIVISION: ', self.compute_norm(differences) / len(self.input_word))
        #print('PAPER SCORE: ', self.euclidean_distances(data_tensor, claim_tensor))
        print()
        print("{:<25} {:<10}".format('Naive Bayes score', 'L1 Norm score'))
