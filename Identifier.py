...
class Identifier:
    ...
    def compute_scores(self, sample):
        bayes_distances = {}
        norm_distances = {}
        print("{:<15} {:<20} {:<20}".format("USERNAME", "BAYES", "NORM"))
        sums = {}
        norms = {}
        ...
        '''
        while True:
            username = input("type your name, we need it! =) :     ")
            print(list(self.classes.keys()))
            if username in list(self.classes.keys()):
                break
            print("The name you entered does not exist, enter it again")
            '''
